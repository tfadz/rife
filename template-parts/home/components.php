<?php if (get_field('home_widgets')) : while (has_sub_field('home_widgets')) : ?>
        ...
        <?php if (have_rows('spotlights')) : while (have_rows('spotlights')) : the_row();
          ...
          <div class="col-lg-4 col-sm-12">
            <div class="thumb-wrap">
              <a class="b-lazy" href="<?php echo $gLink ?>" data-src="<?php echo $gImage['sizes']['large']; ?>">
  ...
  <?php if (get_row_layout() == "lr_image_text"): ?>
    ...
    <section class="container-fluid nopadding lr_img_txt">
      <div class="row">
        <div class="col-lg-6 col-md-12 nopadding-left b-lazy lr_img_txt__img" data-src="<?php echo $image ?>"></div>
